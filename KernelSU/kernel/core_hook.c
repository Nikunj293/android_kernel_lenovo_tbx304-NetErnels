...
int ksu_legacy_task_prctl(int option, unsigned long arg2,
                          ...
                          unsigned long arg5)
{
	return ksu_task_prctl(option, arg2, arg3, arg4, arg5);
}

int ksu_legacy_task_fix_setuid(struct cred *new, const struct cred *old,
                               int flags)
{
	return ksu_task_fix_setuid(new, old, flags);
}
...
{
	return ksu_inode_rename(old_inode, old_dentry,
...
{
        pr_info("KernelSU: legacy 3.18 compatibility hooks enabled\n");
}
